...
-- Show which line your cursor is on (off)
...
vim.keymap.set('n', ';', ':', { desc = 'Shortcut to Command mode' })
...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Override the default handlers to include borders
